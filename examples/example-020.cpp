// This example shows how to use the comet_position_periodic (non-Julian) date.

// How to build:
//
// g++ -Wall -o example-020.out example-020.cpp star.cpp math_misc.cpp time_details.cpp api_interface.cpp coord_conversion.cpp comet_details.cpp sun.cpp moon.cpp planets.cpp
