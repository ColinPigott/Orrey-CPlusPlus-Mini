// This example shows how to use the comet_position_parabolic (non-Julian) method.

// How to build:
//
// g++ -Wall -o example-022.out example-022.cpp star.cpp math_misc.cpp time_details.cpp api_interface.cpp coord_conversion.cpp comet_details.cpp sun.cpp moon.cpp planets.cpp
