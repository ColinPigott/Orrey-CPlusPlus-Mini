// This example shows how to use the ecl_to_hor (non-Julian) method.

// How to build:
//
// g++ -Wall -o example-014.out example-014.cpp star.cpp math_misc.cpp time_details.cpp api_interface.cpp coord_conversion.cpp comet_details.cpp sun.cpp moon.cpp planets.cpp
